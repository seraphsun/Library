...
public class RefreshLayout extends ViewGroup {
    ...
    public static final int STYLE_WATER_DROP = 3;
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.refresh_01);
        final int type = a.getResourceId(R.styleable.refresh_01_refreshType, 0);
        final int colorsId = a.getResourceId(R.styleable.refresh_01_refreshColors, 0);
        final int colorId = a.getResourceId(R.styleable.refresh_01_refreshColor, 0);
        a.recycle();
        ...
        mSpinnerFinalOffset = mTotalDragDistance = UtilDensity.dp2px(getContext(), DRAG_MAX_DISTANCE);
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_ARC:
                mRefreshDrawable = new DrawArc(getContext(), this);
                break;
            case STYLE_CIRCLES:
                mRefreshDrawable = new DrawCircles(getContext(), this);
                break;
            case STYLE_RING:
                mRefreshDrawable = new DrawRing(getContext(), this);
                break;
            case STYLE_WATER_DROP:
                mRefreshDrawable = new DrawWaterDrop(getContext(), this);
                break;
            case STYLE_SMARTISAN:
                mRefreshDrawable = new DrawSmartisan(getContext(), this);
                break;
            default:
