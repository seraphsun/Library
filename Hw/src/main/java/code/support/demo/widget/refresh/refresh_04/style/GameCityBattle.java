...
public class GameCityBattle extends GameView {
    ...
    public GameCityBattle(Context context) {
        this(context, null);
    }

    public GameCityBattle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GameCityBattle(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void resetConfigParams() {
        ...
        status = GameView.STATUS_GAME_PREPAR;
    ...
    private void drawSelfTank(Canvas canvas) {
        ...
        boolean isAboveCrash = checkTankCrash(getTrackIndex((int) controllerPosition), screenWidth - controllerSize, controllerPosition);
        boolean isBelowCrash = checkTankCrash(getTrackIndex((int) (controllerPosition + controllerSize)), screenWidth - controllerSize, controllerPosition + controllerSize);
        ...
        canvas.drawRect(screenWidth - controllerSize - barrelSize, controllerPosition + (controllerSize - barrelSize) * .5f, screenWidth - controllerSize, controllerPosition + (controllerSize - barrelSize) * .5f + barrelSize, mPaint);
    }
