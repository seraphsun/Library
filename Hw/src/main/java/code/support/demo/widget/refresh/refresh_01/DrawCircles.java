 ...
 */
public class DrawCircles extends RefreshDrawable implements Runnable {
    ...
    public DrawCircles(Context context, RefreshLayout layout) {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        mDrawWidth = UtilDensity.dp2px(getContext(), 40);
