...
public class GameHitBlock extends GameView {
    ...
    public GameHitBlock(Context context) {
        this(context, null);
    }

    public GameHitBlock(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GameHitBlock(Context context, AttributeSet attrs, int defStyle) {
